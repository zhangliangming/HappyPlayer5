...
public class SearchResultAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchResultAdapter(HPApplication hPApplication, Context context, ArrayList<AudioInfo> datas) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof SearchResultViewHolder && position < mDatas.size()) {
            AudioInfo audioInfo = mDatas.get(position);
            reshViewHolder(position, (SearchResultViewHolder) viewHolder, audioInfo);
            ...
            tempHolder.getListItemRelativeLayout().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (mSearchResultListener != null) {
                        mSearchResultListener.loadMoreData();
                    }
                }
            });
        }
     ...
     * @param audioInfo
     */
    private void reshViewHolder(final int position, final SearchResultViewHolder viewHolder, final AudioInfo audioInfo) {
        //设置菜单界面
        //1更多按钮点击事件
    ...
    public void setPlayIndexHash(String playIndexHash) {
        this.playIndexHash = playIndexHash;
    }
    ...
    public void setSearchResultListener(SearchResultListener mSearchResultListener) {
