package com.zlm.hp.media.audio.utils;

import com.zlm.hp.media.audio.AudioFileReader;
import com.zlm.hp.media.audio.formats.ape.APEFileReader;
import com.zlm.hp.media.audio.formats.flac.FLACFileReader;
import com.zlm.hp.media.audio.formats.mp3.MP3FileReader;
import com.zlm.hp.media.audio.formats.wav.WAVFileReader;
