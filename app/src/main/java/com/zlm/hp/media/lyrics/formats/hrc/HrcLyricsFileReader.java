package com.zlm.hp.media.lyrics.formats.hrc;
...
import com.zlm.hp.media.lyrics.model.TranslateLyricsInfo;
import com.zlm.hp.media.lyrics.model.TransliterationLyricsInfo;
import com.zlm.hp.media.lyrics.utils.CharUtils;
import com.zlm.hp.media.lyrics.utils.StringCompressUtils;
import com.zlm.hp.media.lyrics.utils.StringUtils;
import com.zlm.hp.media.lyrics.utils.TimeUtils;
...
/**
 * @Description: hrc歌词解析器，乐乐音乐第一版的自定义歌词
 * @Param:
 * @Return:
