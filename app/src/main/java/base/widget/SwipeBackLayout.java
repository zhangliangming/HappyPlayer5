...
public class SwipeBackLayout extends LinearLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        contentView.layout(mContentViewCurX, 0, mContentViewCurX + contentView.getWidth(), contentView.getHeight());
        if (!isLayoutInit) {
        ...
        try {
            ...
            switch (actionId) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    int mDragViewRightX = mDragViewLeftX + contentView.getWidth();
...
//                logger.e("event.getRawX() = " + event.getRawX());
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (contentView.getLeft() < getWidth() / 2) {
                        //在左半边
                        mDragHelper.smoothSlideViewTo(contentView, 0, 0);
                        ViewCompat.postInvalidateOnAnimation(SwipeBackLayout.this);
                    } else {
                        //在右半边
                        mDragHelper.smoothSlideViewTo(contentView, getWidth(), 0);
                        ViewCompat.postInvalidateOnAnimation(SwipeBackLayout.this);
                    }
